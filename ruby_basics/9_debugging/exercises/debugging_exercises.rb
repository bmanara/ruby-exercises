...
require 'pry-byebug'
# Add binding.pry into any line. Once it reaches it, it will open a irb-like
# session in the terminal. Basically adds a breakpoint. 
# Enter next to evaluate next line
# Enter step to step into the line (if it incolves methods)
